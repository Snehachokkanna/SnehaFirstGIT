...
public class Test90PageDivTagCarouselSlider
{
	
	//elements as private properties in page class
	private RemoteWebDriver driver;
	
	//<div> tag carousel slider
	@FindBy(xpath ="(//div[contains(@style,'transform')])[1]")
	private WebElement cslider;
	
	//<div> tag slides under that carousel slider,which will be rotated
	...
	//constructor method
	public Test90PageDivTagCarouselSlider(RemoteWebDriver driver)
		{
			this.driver=driver;
	...
	public boolean VerifySlidesRotationInCoursalSlider() throws Exception
	{
		...
		if(csliderslides.get(0).findElement(By.xpath("descendant::img[1]")).isDisplayed())	
		{
			return(true);
		}
		else
